...
export const DEMO_PERSONAS: DemoPersona[] = [
  ...
  { key: "grants-compliance", label: "Grants Manager (compliance)", note: "compliance, data integrity, expenditure responsibility — team + programs-only", sub: "demo-r-baptiste", email: "r.baptiste@gitlabfoundation.example", name: "Rhea Baptiste", groups: ["grants-ops", "grants-compliance"] },
  ...
  { key: "impact-director", label: "Director of Impact", note: "evidence strategy — team + programs-only", sub: "demo-n-okonkwo", email: "n.okonkwo@gitlabfoundation.example", name: "Nadia Okonkwo", groups: ["impact", "impact-director"] },
  ...
  { key: "coo", label: "Chief Operating Officer", note: "operations, process, access owner — team + programs-only", sub: "demo-m-delacroix", email: "m.delacroix@gitlabfoundation.example", name: "Mara Delacroix", groups: ["coo", "operations", "leadership"] },
  { key: "finance", label: "Finance (CFO / Controller)", note: "commitments vs. disbursements, payout — team + programs-only", sub: "demo-t-caden", email: "t.caden@gitlabfoundation.example", name: "Tomas Caden", groups: ["finance", "accounting"] },
