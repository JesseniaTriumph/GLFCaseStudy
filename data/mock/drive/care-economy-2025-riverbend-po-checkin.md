...
expect to recover in Year 2 once the state issues clear.

**Wage outcomes.** Ahead of plan. Median wage at placement is running around $19/hr
against a regional baseline closer to $17 — a larger gap than we modeled at approval.

**Recommendation.** Renewal looks warranted, but with a **revised ramp** — hold them to
